...
#
# Generated by Vivado on Tue Jun 11 14:45:45 +0300 2024
...
xv_boost_lib_path=H:/VIVA/Vivado/2019.1/tps/boost_1_64_0
xvlog_opts="--relax"
xvhdl_opts="--relax"
...
{
  file="xsim.ini"
  lib_map_path="H:/VIVA/Vivado/2019.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
